...
PM02_DF_V1 = query_api.query_data_frame(
    f'from(bucket:"{config["bucket"]}")'
        f'|> range(start: 2022-07-24T00:00:00Z, stop: 2023-12-31T00:00:00Z) '
        '|> filter(fn: (r) =>'
...
IRRADIANCE_DF_V1=query_api.query_data_frame(
    f'from(bucket:"{config["bucket"]}")'
        f'|> range(start: 2022-07-24T00:00:00Z, stop: 2023-03-31T00:00:00Z) '
        '|> filter(fn: (r) =>'
...
# Delete the columns , 'result','table','_start' and '_stop'
